...
* FNightVisionParams is ur custom param name, can name it anything
...
*/
BEGIN_SHADER_PARAMETER_STRUCT(FNightVisionParams,)
...
class FNightVisionPS : public FGlobalShader
{
	DECLARE_EXPORTED_SHADER_TYPE(FNightVisionPS, Global, );
	using FParameters = FNightVisionParams;
	SHADER_USE_PARAMETER_STRUCT(FNightVisionPS, FGlobalShader);
