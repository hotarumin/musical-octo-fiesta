 ...
 * 
 */
class THERMALVISION_API FThermalVisionCustomSceneViewExtension : public FSceneViewExtensionBase
{ /* Yilin notes : THERMALVISION_API is auto generated inside Definitions.ThermalVision.h 
   ...
   * this SVE is also referenced in ThermalVisionCustomShaderSubsystem.h
   */

public:
	FThermalVisionCustomSceneViewExtension(const FAutoRegister& AutoRegister);
