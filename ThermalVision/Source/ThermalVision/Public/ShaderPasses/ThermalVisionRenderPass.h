...
* FThermalVisionParams is ur custom param name, can name it anything
...
*/
BEGIN_SHADER_PARAMETER_STRUCT(FThermalVisionParams,)
...
{
	DECLARE_EXPORTED_SHADER_TYPE(FThermalVisionPS, Global, );
	using FParameters = FThermalVisionParams;
