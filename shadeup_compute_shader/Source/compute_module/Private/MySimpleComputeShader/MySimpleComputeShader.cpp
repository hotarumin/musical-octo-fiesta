...
class COMPUTE_MODULE_API FMySimpleComputeShader: public FGlobalShader
{
public:
...
IMPLEMENT_GLOBAL_SHADER(FMySimpleComputeShader, "/compute_moduleShaders/MySimpleComputeShader/MySimpleComputeShader.usf", "MySimpleComputeShader", SF_Compute);
