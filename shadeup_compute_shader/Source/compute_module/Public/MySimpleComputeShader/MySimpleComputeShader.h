...
struct COMPUTE_MODULE_API FMySimpleComputeShaderDispatchParams
{
	int X;
	int Y;
	int Z;
...
class COMPUTE_MODULE_API FMySimpleComputeShaderInterface {
public:
...
class COMPUTE_MODULE_API UMySimpleComputeShaderLibrary_AsyncExecution : public UBlueprintAsyncActionBase
{
	GENERATED_BODY()
